...
if(!$origin_point){ //location could'nt be found
    ...
    <div class="bbp-template-notice">
            <p><?php printf(__( 'This search returns <strong>only</strong> %1s that are geolocated %2s %3s around "%4s"', 'bbptl' ),bbptl_get_post_type_list($post_types),$origin_point['Distance'],$unit['name'],$origin_point['Address']); ?></p>
    </div>
    <?php
}
?>
